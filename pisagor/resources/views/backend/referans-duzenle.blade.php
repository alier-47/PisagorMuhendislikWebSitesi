                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_content">
                                    ...
                                    <div class="col-md-55" id="resim{{$sira}}">
                                        <div class="thumbnail">
                                            <div class="image view view-first">
                                                <img style="width: 100%; display: block;" src="/uploads/img/binalar/{{$resim->resim_Yol}}" alt="image" />
                                                <div class="mask">
                                                    <div class="tools tools-bottom">
                                                        <input type="hidden" name="resim" value="{{$resim->resim_Yol}}">
                                                         <button  onclick="sil(this,'{{$referans->slug}}','{{$resim->resim_Yol}}','resim{{$sira}}')" class="btn btn-danger"><i class="fa fa-times"></i></button>
                            ...
                            <form method="post" action="/admin/referanslar/referans-duzenle/{{$referans->slug}}" id="form" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                {{ Form::bsText('bina_adi','Bina Adı *', $referans->bina_adi) }}
                                {{ Form::bsText('yer','Adres', $referans->yer) }}
                                <div class="form-group">
                ...
                success:function (response) {
                    if (response.durum == 'success') {
                        Swal.fire({
                            ...
                            confirmButtonText: 'Referans Listesine Dön',
                            cancelButtonText: 'Kapat',
                            cancelButtonColor: '#00a275',

                        }).then(function (result) {
                            if (result.value) {
                                setTimeout ("window.location='/admin/referanslar'");
                            }
                        });
                    }else{
                        Swal.fire(
